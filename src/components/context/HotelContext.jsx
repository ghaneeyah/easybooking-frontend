...
export const HotelProvider = ({ children, currentUser }) => {
    ...
    const fetchHotels = async () => {
        ...
        try {
            const response = await axios.get('https://hotel-api-1jnm.onrender.com/api/hotel/list');
    ...
    const fetchHotelById = async (id) => {
        ...
        try {
            ...
            const response = await axios.get(`https://hotel-api-1jnm.onrender.com/api/hotel/${id}`);
    ...
    const fetchHotelRooms = async () => {
        ...
        try {
            const response = await axios.get('https://hotel-api-1jnm.onrender.com/api/hotelrooms/get');
    ...
    const fetchHotelRoomById = async (id) => {
        setLoadingRooms(true);
        try {
            const response = await axios.get(`https://hotel-api-1jnm.onrender.com/api/hotelrooms/${id}`);
    ...
    const setBooking = (data) => {
      ...
      const createBooking = async (bookingData) => {
        try {
          ...
          const response = await axios.post("https://hotel-api-1jnm.onrender.com/api/bookings/create", bookingData, {
            headers: {
