...
const HotelDetails = () => {
  ...
  const hotelImage = Array.isArray(hotel.image) && hotel.image.length > 0 
    ? `https://hotel-api-1jnm.onrender.com/${hotel.image[0]}` 
    : 'default-image.jpg';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {roomsForHotel.length > 0 ? roomsForHotel.map((room) => (
            <div key={room._id} className="bg-white rounded-lg shadow-md p-4">
              ...
              <img 
                src={`https://hotel-api-1jnm.onrender.com/${room.image && room.image.length > 0 ? room.image[0] : 'default-room-image.jpg'}`} 
