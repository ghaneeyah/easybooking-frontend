...
const HomePage = () => {
  ...
  const getRoomImages = (roomName) => {
    ...
    return room ? room.imageNames.map((image) => `https://hotel-api-1jnm.onrender.com/uploads/${image}.jpg`) : [];
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredHotels.map((hotel) => (
              ...
              >
                <img
                  src={`https://hotel-api-1jnm.onrender.com/${Array.isArray(hotel.image) ? hotel.image[0] : hotel.image}`}
                  alt={hotel.name}
            ...
            {filteredRooms.map((room) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                   <img src={`https://hotel-api-1jnm.onrender.com/${room.image && room.image.length > 0 ? room.image[0] : 'default-room-image.jpg'}`} />
